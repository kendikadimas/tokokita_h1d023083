...
### **Prerequisites**
1. Flutter SDK (versi 2.0+)
2. Dart SDK 
3. Android Studio / VS Code
4. Backend API Server (CodeIgniter 4)
5. Database MySQL
...
4. Update `api_url.dart` dengan URL backend Anda
5. Jalankan `flutter run` untuk menjalankan aplikasi
